...
catalogo = Catalogo(host='NahuelCamposs.mysql.pythonanywhere-services.com', user='NahuelCamposs', password='root-123456', database='NahuelCamposs$miapp')

# Carpeta para guardar las imagenes
ruta_destino = '/home/NahuelCamposs/mysite/static/imagenes/'   #recordar poner / después de imágenes
